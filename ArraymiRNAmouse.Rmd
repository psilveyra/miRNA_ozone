...
boxplot(CTvaluesM)
summary(CTvaluesM)
plotCtHeatmap(CTvaluesM, gene.names = miRNAlist, sample.names = pheno$code, dist = "euclidean", "CT by day")
plotCtHeatmap(CTvaluesM, gene.names = miRNAlist, sample.names = pheno$Treatment, dist = "euclidean", "CT all cycles")
plotCtHeatmap(CTvaluesM, gene.names = miRNAlist, dist = "euclidean", "CT all cycles")
```
...
datawithID22=read.csv("expression12.csv")
...
```{r}
design4=model.matrix(~0 + pheno$codeP)
...
```{r}
par(mfrow=c(2,3))
boxplot(ExpvaluesFnoP[38,] ~ pheno2FnoP$codeP, main = miRNAlist2[38], ylab = "expression", xlab ="p=0.027")
boxplot(ExpvaluesFnoP[54,] ~ pheno2FnoP$codeP, main = miRNAlist2[54], ylab = "expression", xlab ="p=0.039")
```
...
```{r}
par(mfrow=c(2,3))
boxplot(ExpvaluesFP[71,] ~ pheno2FP$codeP, main = miRNAlist2[71], ylab = "expression", xlab ="p=0.00015")
boxplot(ExpvaluesFP[73,] ~ pheno2FP$codeP, main = miRNAlist2[73], ylab = "expression", xlab ="p=0.00025")
boxplot(ExpvaluesFP[35,] ~ pheno2FP$codeP, main = miRNAlist2[35], ylab = "expression", xlab ="p=0.003")
boxplot(ExpvaluesFP[26,] ~ pheno2FP$codeP, main = miRNAlist2[26], ylab = "expression", xlab ="p=0.0055")
boxplot(ExpvaluesFP[75,] ~ pheno2FP$codeP, main = miRNAlist2[75], ylab = "expression", xlab ="p=0.0092")
boxplot(ExpvaluesFP[72,] ~ pheno2FP$codeP, main = miRNAlist2[72], ylab = "expression", xlab ="p=0.013")
boxplot(ExpvaluesFP[9,] ~ pheno2FP$codeP, main = miRNAlist2[9], ylab = "expression", xlab ="p=0.019")
boxplot(ExpvaluesFP[32,] ~ pheno2FP$codeP, main = miRNAlist2[32], ylab = "expression", xlab ="p=0.023")
boxplot(ExpvaluesFP[11,] ~ pheno2FP$codeP, main = miRNAlist2[11], ylab = "expression", xlab ="p=0.038")
```
...
```{r}
boxplot(ExpvaluesL[71,] ~ pheno$codeP, main = miRNAlist2[71], ylab = "expression")
```
...
aheatmap(ExpvaluesL3, color = colorRampPalette(c("navy", "white", "firebrick3"))(50), scale="row", Colv = NA, Rowv=NA, annCol = myt, border = T)
```


```{r}
par(mfrow=c(1,1))
codesFP=pheno2FP$codeP
colnames(ExpvaluesFPsel)=codesFP
myt = data.frame(Treatment = pheno2FP$Treatment)
aheatmap(ExpvaluesFPsel, color = colorRampPalette(c("navy", "white", "firebrick3"))(50), scale="row", Colv = NA, Rowv=NA, annCol = myt, border = T)

codesFnoP=pheno2FnoP$codeP
